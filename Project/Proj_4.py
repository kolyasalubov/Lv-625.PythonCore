...
class App(tk.Tk):
    def __init__(self):
        ...
        button = tk.Button(frame, 
                        ...
                        command=lambda: my_pen())
        button.place(relx=0.1, rely=0, relwidth=0.05, relheight=1)
        ...
        button.place(relx=0.15, rely=0, relwidth=0.1, relheight=1)
        ...
        button.place(relx=0.25, rely=0, relwidth=0.05, relheight=1)
        ...
        button.place(relx=0.3, rely=0, relwidth=0.05, relheight=1)
        ...
        button.place(relx=0.35, rely=0, relwidth=0.05, relheight=1)
        ...
        button.place(relx=0.4, rely=0, relwidth=0.05, relheight=1)
        button = tk.Button(frame, 
                        text="blue", 
                        bg="blue", fg="white", 
                        font=('Courier', 12), 
        ...
        button.place(relx=0.45, rely=0, relwidth=0.05, relheight=1)
        button = tk.Button(frame, 
                        text="Open", 
                        bg="gray", fg="white", 
                        font=('Courier', 12), 
        ...
        button.place(relx=0.5, rely=0, relwidth=0.05, relheight=1)
        button = tk.Button(frame, 
                        text="Clear", 
                        bg="gray", fg="white", 
                        font=('Courier', 12), 
                        ...
                        # command = my_event_handler)
        button.place(relx=0.55, rely=0, relwidth=0.05, relheight=1)
        button = tk.Button(frame, 
                        text="Eraser", 
                        bg="gray", fg="white", 
                        font=('Courier', 12), 
        ...
        def my_save():
            ...
            ImageGrab.grab().crop((x,y,x1,y1)).save("file_path_here.jpg")
        ...
        def create_figure(x1, y1, x2, y2, figure):
            ...
            coordinat_list = ([figure, x1, y1, x2, y2, glob_color],)
