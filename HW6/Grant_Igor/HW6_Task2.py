...
if figure == 1:
    ...
    print(f"The squere of rectangle is: {sq.rectangle(side_rect_a, side_rect_b)}")
elif figure == 2:
    side_trian_a = float(input("Input side a: "))
    side_trian_b = float(input("Input side b: "))
    side_trian_c = float(input("Input side c: "))
    print(f"The squere of the triangle is: {sq.triangle(side_trian_a, side_trian_b, side_trian_c)}")
elif figure == 3:
    rad_cir = float(input("Input circle radius: "))
    print(f"The squere of the circle is: {sq.circle(rad_cir)}")
